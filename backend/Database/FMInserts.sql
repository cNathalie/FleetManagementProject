...
VALUES
  ('Janssens', 'Peter', 'Kerkstraat 123', '75063012345', 1),
  ('Vermeulen', 'Sarah', 'Dorpstraat 45', '98020023456', 2),
  ('De Vos', 'Lucas', 'Havenlaan 78', '01080034567', 3),
  ('Peeters', 'Lotte', 'Schoolstraat 12', '88050045678', 4),
  ('Jacobs', 'Eva', 'Parkweg 67', '91020056789', 5),
  ('Van Damme', 'Michael', 'Boslaan 34', '92070067890', 6),
  ('Lenaerts', 'Lise', 'Kanaalstraat 56', '73100078901', 7),
  ('Wouters', 'David', 'Dennenweg 89', '86110089012', 8),
  ('Smet', 'Julie', 'Zuidlaan 23', '70063000123', 9),
  ('Maes', 'Max', 'Kastanjelaan 12', '80123111234', 10),
  ('Bosmans', 'Emma', 'Eikenlaan 45', '02102034556', 11),
  ('Verhoeven', 'Noah', 'Lindenstraat 78', '03062045667', 12),
  ('Peters', 'Olivia', 'Wilgenweg 34', '82121456778', 13),
  ('Cools', 'Luc', 'Birkenweg 67', '84110567889', 14),
  ('Jansen', 'Mia', 'Kastanjeplein 89', '10073178990', 15),
  ('Van den Broeck', 'Liam', 'Kanaaldijk 23', '11113089001', 16),
  ('Peeters', 'Sophie', 'Beukenlaan 56', '70000000112', 1),
  ('De Sutter', 'Finn', 'Eikenstraat 12', '81010111223', 2),
  ('Lemmens', 'Lara', 'Dennenlaan 45', '92063012334', 3),
  ('Willems', 'Julien', 'Kastanjeweg 78', '75012323445', 4),
  ('Bernaerts', 'Zoe', 'Wilgenlaan 34', '88023434556', 5),
  ('Verhaegen', 'Sam', 'Kerklaan 67', '99011145667', 6),
  ('Smeets', 'Ella', 'Dorpstraat 89', '04040456778', 7),
  ('Maertens', 'Lucas', 'Parkweg 23', '98121267889', 8),
  ('Jacobs', 'Julia', 'Boslaan 56', '75111578990', 9),
  ('De Vries', 'Sem', 'Kanaalstraat 12', '91013189001', 10),
  ('Van Hout', 'Fleur', 'Zuidlaan 45', '85042500112', 11),
  ('Bosch', 'Nina', 'Schoolweg 78', '02121211223', 12),
  ('Vermeiren', 'Nick', 'Havenplein 34', '10012312334', 13);
