...
import { getFleets, UpdateFleet, DeleteFleet, PostFleet} from "../constants/Api";
...
const FleetPage = () => {
  ...
  return (
    <>
        ...
        >
          <DetailChange setPopupVisibility={setPopupVisibility} UpdateVoertuig={UpdateFleet} tempObject={temp.tempObject}/>
        </div>
        ...
        >
          <AddItem setPopupVisibility={setPopupVisibility} apiCmd={PostFleet} initialFormData={initialFleetsFormData[0]}/>
        </div>
