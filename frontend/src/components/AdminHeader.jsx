  ...
  return (
    <div className="w-[100%] h-[100px] flex justify-center">
      ...
      <div className="flex justify-between my-14 w-[786px] h-[43px]">
        <button
          className="relative w-[201px] h-[43px] bg-[#ffffff] rounded-[10px] border border-solid border-[#0b5a64] hover:bg-[#0b5a64] hover:text-[#ffffff] [font-family: 'Inter-SemiBold',Helvetica] font-semibold"
          onClick={() => {
            navigate(-1);
          }}
        >
