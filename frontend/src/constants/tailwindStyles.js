export const BUTTON_STYLES = {
    ...
    POPUP_RIGHT: 'bg-blueBtn w-[100px] h-8 text-center text-whiteText font-mainFont font-btnFontWeigt text-popupTextSize rounded-lg cursor-pointer hover:bg-hoverBtn ml-6',
};
...
export const TEXT_STYLES = {
    ...
    POPUP_TEXT: 'font-mainFont font-titleFontWeigt text-popupTextSize text-[#858585] pt-2',
};
